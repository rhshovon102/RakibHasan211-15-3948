            ...
            child: Center(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text('Weather Status: $description', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                  Text('City/Country: $city', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
                ],
              ),
            ),
          ),
